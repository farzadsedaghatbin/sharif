Sharif: Assortment of technologies including Arquillian
========================
Author: Mostafa Rastgar extends Pete Muir
Level: Intermediate
...
4. This will deploy `target/Sharif.war` to the running instance of the server.
 

Access the application 
---------------------

The application will be running at the following URL: <http://localhost:8080/Sharif/>.
